...
async function startServer() {
    try {
        await initializeDatabase();   // cria todas as tabelas se não existirem
        await initializeSiteTexts();  // inicializa textos padrão do site
...
startServer(); // chama a função async para iniciar